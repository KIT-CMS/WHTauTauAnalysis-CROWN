...
def build_config(
    ...
    configuration.add_producers(
        ...
        [
            ...
            # pairselection.EMTTripleSelectionWOEle,
            pairselection.LVEl1,
            pairselection.LVMu2,
    ...
    configuration.add_producers(
        "met",
        [
            pairselection.METTripleSelection,
            pairselection.LVEl2,
            pairselection.LVMu1,
            pairselection.LVEl2Uncorrected,
            pairselection.LVMu1Uncorrected,
            pairquantities.METTripleQuantities,
    ...
    configuration.add_producers(
        ...
        [
            ...
            pairquantities.mt,
            pairselection.GoodTripleFilter,
            pairselection.MMTTripleSelection,
            # pairselection.EMTTripleSelectionWOEle,
            pairselection.LVMu2,
            pairselection.LVMu1,
            pairselection.LVMu2Uncorrected,
            pairselection.LVMu1Uncorrected,
            pairquantities.MMTTripleQuantities,
    ...
    configuration.add_producers(
        ...
        [
            ...
            pairquantities.mt,
            pairselection.GoodTripleFilter,
            pairselection.ETTTripleSelection,
            pairselection.LVEl1,
            pairselection.LVEl1Uncorrected,
            pairquantities.ETTTripleQuantities,
    ...
    configuration.add_producers(
        ...
        [
            ...
            pairquantities.mt,
            pairselection.GoodTripleFilter,
            pairselection.MTTTripleSelection,
            pairselection.LVMu1,
            pairselection.LVMu1Uncorrected,
            pairquantities.MTTTripleQuantities,
    ...
    configuration.add_producers(
        ...
        [
            ...
            pairselection.LVMu1,
            pairselection.LVEl3,
            pairselection.LVEl3Uncorrected,
            pairselection.LVMu2Uncorrected,
            pairselection.LVMu1Uncorrected,
            pairquantities.MMETripleQuantities,
    ...
    configuration.add_producers(
        ...
        [
            ...
            pairselection.LVEl2Uncorrected,
            pairselection.LVMu3,
            pairselection.LVMu3Uncorrected,
            pairquantities.EEMTripleQuantities,
