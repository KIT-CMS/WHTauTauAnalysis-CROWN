...
p4_miss = Producer(
    name="p4_miss",
    call="lorentzvectors::p4_miss({df}, {output}, {input_vec}, {p4_miss_sf})",
    input=[q.p4_2, q.p4_3],
    output=[q.p4_miss],
...
m_tt = Producer(
    name="m_tt",
    call="quantities::m_tt({df}, {output}, {input_vec})",
    input=[q.p4_2, q.p4_3, q.p4_miss],
    output=[q.m_tt],
    scopes=["emt", "met", "mmt", "mme", "eem", "ett", "mtt"],
)
pt_W = Producer(
    ...
    input=[q.p4_1, q.met_p4_recoilcorrected, q.p4_miss],
    output=[q.pt_W],
    scopes=["emt", "met", "mmt", "ett", "mtt", "mme", "eem"],
)
deltaR_13 = Producer(
