...
deltaPhi_elemu = Quantity("deltaPhi_elemu")
deltaPhi_eletau = Quantity("deltaPhi_eletau")
...
deltaR_eletau_wh = Quantity("deltaR_eletau_wh")
deltaR_mutau_wh = Quantity("deltaR_mutau_wh")
deltaR_elemu_wh = Quantity("deltaR_elemu_wh")
